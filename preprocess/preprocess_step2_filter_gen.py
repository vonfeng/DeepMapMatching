...
def filter_2sigma(trace, sigma=0.001):
    """
            ...
            if trace.shape[0] > 1:
                ...
                if max_time_gap < MAX_TIME_GAP and average_time_gap < MAX_AVE_TIME_GAP:  # 1. 最大时间间隔， 2.平均时间间隔
                    ...
                    if dist > MIN_DIST and max_gap < MAX_GAP:  # 3.轨迹内最大空间间隔， 4.轨迹长度
                        ...
                        traces.append(group_name[0] + ':' + trace)
...
def main():
    ...
    # 配置路径
    path = '../../data/tencent/preprocessed/step1_gen/'
    path_out = '../../data/tencent/preprocessed/step2_gen/'
    path_out_stat = '../../data/tencent/preprocessed/step2_statistics_gen.txt'
